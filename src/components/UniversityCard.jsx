...
const UniversityCard = ({ university }) => {
  return (
    <div className="border border-gray-200 dark:border-gray-700 p-4 rounded-xl shadow-sm bg-white dark:bg-gray-800 hover:shadow-xl transition-all duration-300">
